""" usage: partition_dataset.py [-h] [-i IMAGEDIR] [-o OUTPUTDIR] [-r RATIO] [-j]
...
def iterate_dir(source, dest, ratio, copy_json):
...
def main():
    ...
    iterate_dir(args.imageDir, args.outputDir, args.ratio, args.json)
